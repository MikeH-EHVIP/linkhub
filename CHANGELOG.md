...
### Added
- **Collections System**: Introduced nested Collections to replace flat Headings. Collections can contain links and support custom styling.
- **SortableJS**: Added library for robust nested drag-and-drop.
